...

{
	 ...
	 * 
	 * @param name
	 *            is the name of the bank as type string
...

	{
...

		{
...

			{
				...
				display += temp.get(i).getAccountType()
						+ "Owner: "
						+

						temp.get(i).getOwner().getFirstName()
						+ " " + temp.get(i).getOwner().getLastName() + " "
						+ dob.format(temp.get(i).getOwner().getbirthDate()
								.getTime()) + ", Balance: " + new

						DecimalFormat("#.00").format(temp.get(i).getBalance())
...

		{
...

			{
				display += _accounts.get(i).getAccountType()
						...
						_accounts.get(i).getOwner().getFirstName()

						+ " " + temp.get(i).getOwner().getLastName() + " " 
						+ dob.format(_accounts.get(i).getOwner().getbirthDate()
								.getTime())
						+ ", Balance: "
						+ new DecimalFormat("#.00").format(_accounts.get(i)
								.getBalance()) + "\n"
